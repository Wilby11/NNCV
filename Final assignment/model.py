...
class Model(nn.Module):
    ...
    def __init__(
        ...
        in_channels=3, 
        n_classes=20,
        dropout_p=0.1  # New: Dropout probability
    ):
        """
        Args:
            in_channels (int): Number of input channels. Default is 3 for RGB images.
            n_classes (int): Number of output classes. Default is 20 for Cityscapes including void.
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, dropout_p=0.1, bilinear=True):
        super().__init__()
